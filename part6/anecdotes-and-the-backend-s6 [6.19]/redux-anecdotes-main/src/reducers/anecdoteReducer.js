...
//things not needed if db.json is the data 
...
const anecdoteSlice = createSlice({
  ...
  initialState: [],
  reducers: {
    //createAnecdote definition removed from here!
...
export const { incrementAnecdote, appendAnecdote, setAnecdotes } = anecdoteSlice.actions
...
//6.18 answer
export const udpateAnecdoteVotes = (id, voteToChange) => {  
  return async dispatch => {   
